...
export default function PyqScreen() {
  ...
  <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-margin-mobile md:px-margin-desktop h-16 bg-surface/80 dark:bg-surface-dim/80 backdrop-blur-md pt-safe border-b border-outline-variant/30">
    <div className="flex items-center gap-3">
      ...
      <span className="font-headline-md text-headline-md font-bold text-primary dark:text-primary-fixed-dim">Sailor Prep</span>
    </div>
    <div className="flex items-center">
      <button className="p-2 rounded-full hover:bg-surface-container-low dark:hover:bg-surface-container-high text-on-surface-variant dark:text-on-surface-variant transition-colors active:scale-95 duration-200 ease-in-out">
  ...
  <main className="flex-grow pt-[88px] pb-[100px] px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
    ...
    <div className="mb-10 flex gap-3 overflow-x-auto no-scrollbar pb-2">
      ...
      <button className="chip-inactive rounded-full px-5 py-2 font-label-md text-label-md whitespace-nowrap transition-colors shadow-sm">
        General Mechanics
      </button>
      <button className="chip-inactive rounded-full px-5 py-2 font-label-md text-label-md whitespace-nowrap transition-colors shadow-sm">
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
      <div className="md:col-span-8 tonal-card rounded-2xl overflow-hidden relative group cursor-pointer flex flex-col justify-between p-8 min-h-[320px] bg-white border border-outline-variant/40 shadow-md hover:shadow-xl transition-all duration-300">
      ...
      <div className="md:col-span-4 tonal-card rounded-2xl p-8 flex flex-col justify-center relative overflow-hidden bg-primary text-on-primary shadow-lg border-none">
        ...
        <span className="material-symbols-outlined text-5xl mb-6 text-primary-fixed" style={{fontVariationSettings: '"FILL" 1'}}>history_edu</span>
        ...
        <div className="flex justify-between items-center text-on-primary">
          ...
          <div className="flex items-center gap-2 font-headline-md text-headline-md bg-white/10 px-3 py-1 rounded-lg backdrop-blur-sm">
            <span className="material-symbols-outlined text-tertiary-fixed text-xl" style={{fontVariationSettings: '"FILL" 1'}}>local_fire_department</span>
            12 Days
          </div>
        </div>
      </div>
      <div className="md:col-span-12 mt-8 mb-4 flex justify-between items-end border-b border-outline-variant/30 pb-4">
        ...
        <button className="font-label-md text-label-md text-primary hover:text-surface-tint transition-colors flex items-center gap-1 bg-surface-container-low px-3 py-1.5 rounded-full hover:bg-surface-container">Sort by Year <span className="material-symbols-outlined text-sm">expand_more</span></button>
      </div>
      <div className="md:col-span-6 lg:col-span-4 tonal-card rounded-2xl p-6 cursor-pointer group bg-white border-outline-variant/30 hover:border-primary/30">
  ...
  <nav className="hidden md:flex fixed top-16 left-0 h-[calc(100vh-64px)] w-[80px] flex-col items-center py-8 gap-8 border-r border-outline-variant/20 bg-surface/50 backdrop-blur-sm z-40">
    <button className="flex flex-col items-center text-on-surface-variant hover:text-primary transition-colors p-2 rounded-lg hover:bg-surface-container-low" title="Home">
      <span className="material-symbols-outlined">home</span>
    </button>
    <button className="flex flex-col items-center text-on-surface-variant hover:text-primary transition-colors p-2 rounded-lg hover:bg-surface-container-low" title="Tests">
    ...
    <button className="flex flex-col items-center text-on-surface-variant hover:text-primary transition-colors p-2 rounded-lg hover:bg-surface-container-low" title="Notes">
      <span className="material-symbols-outlined">style</span>
    </button>
    <div className="flex-grow" />
    <button className="flex flex-col items-center text-on-surface-variant hover:text-primary transition-colors p-2 rounded-lg hover:bg-surface-container-low" title="Profile">
