...
export default function WelcomeScreen() {
  const filled = '"FILL" 1';
  return (
    <div className="min-h-screen bg-background text-on-background h-full flex flex-col font-body-md overflow-hidden antialiased relative">
      ...
      {/* Decorative Bottom Wave Element */}
        ...
        <div className="z-10 flex flex-col items-center text-center w-full max-w-md animate-fade-in-up">
          ...
          <div className="mb-10 relative group">
            ...
            <div className="w-32 h-32 md:w-36 md:h-36 rounded-full glass-panel flex items-center justify-center relative z-10">
              <Anchor className="text-primary text-[56px]" style={{ fontVariationSettings: filled }} />
            </div>
          </div>

          {/* Typography */}
          <div className="space-y-4 mb-12 glass-panel p-8 rounded-3xl w-full">
            <h1 className="font-display-lg text-display-lg md:font-display-lg md:text-display-lg bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-container leading-tight tracking-tight font-bold">
              Master Your Maritime Exams
            </h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xs mx-auto leading-relaxed">
